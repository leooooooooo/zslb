...
@interface zslbBYZYQKTableViewController ()
@property(nonatomic,retain) NSArray *array;
@end

@implementation zslbBYZYQKTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    NSDictionary *dic = [Post getSynchronousRequestDataJSONSerializationWithURL:[NSString stringWithFormat:Server,@"M_zslb/Service/Operation/GetMonthOperation.aspx"] withHTTPBody:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil)
    {
        ...
        //Fund
        CGRect FundRect = CGRectMake(WIDTH/2-95, i.y, 50, 22);
        ...
        //DOD
        CGRect DODRect = CGRectMake(WIDTH/2-50, i.y, 85, 22);
        ...
        //aaa
        CGRect aaaRect = CGRectMake(WIDTH-175, i.y, 85, 22);
        ...
        //bbb
        CGRect bbbRect = CGRectMake(WIDTH-95, i.y, 85, 22);
        UILabel *bbbLabel = [[UILabel alloc]initWithFrame:bbbRect];
        bbbLabel.font = [UIFont systemFontOfSize:16];
        bbbLabel.tag = 5;
        bbbLabel.textAlignment= NSTextAlignmentCenter;
        //aaaLabel.textColor = [UIColor whiteColor];
        [cell.contentView addSubview:bbbLabel];
    }
    ...
    //bbb
    ((UILabel *)[cell.contentView viewWithTag:5]).text = [[self.array objectAtIndex:indexPath.row]objectAtIndex:4];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    //Fund
    UILabel *Fund = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH/2-95, i.y, 50, 20)];
    i = Fund.frame.origin;
    ///j = Fund.frame.size;
    ...
    //DOD
    UILabel *DOD = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH/2-50, i.y, 85, 20)];
    ...
    //aaa
    UILabel *aaa = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-175, i.y, 85, 20)];
