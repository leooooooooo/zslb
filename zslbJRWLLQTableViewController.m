...
@interface zslbJRWLLQTableViewController ()
@property(nonatomic,retain) NSArray *array;
@end

@implementation zslbJRWLLQTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    NSDictionary *dic = [Post getSynchronousRequestDataJSONSerializationWithURL:[NSString stringWithFormat:Server,@"M_zslb/Service/MaterialConsumption/GetTodayMaterialOutStorage.aspx"] withHTTPBody:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil)
    {
        ...
        //Fund
        CGRect FundRect = CGRectMake(WIDTH/2-60, i.y, 80, 22);
        ...
        //DOD
        CGRect DODRect = CGRectMake(WIDTH-130, i.y, 120, 22);
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    //Fund
    UILabel *Fund = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH/2-45, i.y, 50, 20)];
    i = Fund.frame.origin;
    ///j = Fund.frame.size;
    ...
    //DOD
    UILabel *DOD = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-130, i.y, 120, 20)];
