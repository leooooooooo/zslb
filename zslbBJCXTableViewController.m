...
@interface zslbBJCXTableViewController ()
@property(nonatomic,retain) NSArray *array;
@end

@implementation zslbBJCXTableViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    NSDictionary *dic = [Post getSynchronousRequestDataJSONSerializationWithURL:[NSString stringWithFormat:Server,@"M_zslb/Service/SafetyProduction/GetAlarmEnquiriesInformation.aspx"] withHTTPBody:@"startRow=1&Count=14"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell == nil)
    {
        ...
        //Date
        CGRect DateRect = CGRectMake(10,11,80,22);
        ...
        //Fund
        CGRect FundRect = CGRectMake(WIDTH/2-75, i.y, 80, 22);
        ...
        //DOD
        CGRect DODRect = CGRectMake(WIDTH/2-20, i.y, 85, 22);
        ...
        //aaa
        CGRect aaaRect = CGRectMake(WIDTH-145, i.y, 150, 22);
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    //DOD
    UILabel *DOD = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH/2-20, i.y, 85, 20)];
    ...
    //aaa
    UILabel *aaa = [[UILabel alloc]initWithFrame:CGRectMake(WIDTH-115, i.y, 85, 20)];
